  ...
  try {
    ...
    if (authUser) {
      ...
      if (!currentUser) {
        ...
        let newPermisos = S.usuarios.length === 0 ? ['asignar_territorios', 'asignar_reunion_entre_semana', 'asignar_reunion_fin_semana', 'editar_hermanos', 'añadir_eventos', 'subir_anuncios', 'asignar_sonido', 'asignar_acomodadores', 'asignar_limpieza'] : [];
