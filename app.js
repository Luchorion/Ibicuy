    ...
    view.innerHTML = tabsHtml + `
      <div class="card">
        ...
        <div style="display:flex; justify-content:space-between; margin-top:15px; text-align:center;">
          <div><p style="font-size:1.8rem; font-weight:800; color:var(--accent-primary);">${hMes}</p><p style="font-size:0.75rem; text-transform:uppercase;">Horas Mes</p></div>
          <div><p style="font-size:1.8rem; font-weight:800; color:var(--success);">${hAno}</p><p style="font-size:0.75rem; text-transform:uppercase;">Horas Año</p></div>
        </div>
        <button class="btn btn-primary" style="margin-top:24px;" onclick="enviarInforme()"><i class="fa-solid fa-paper-plane" style="margin-right:8px;"></i>Enviar Informe</button>
      ...
      html += `
        <div class="card" style="display:flex; justify-content:space-between; align-items:center;">
          <div>
            ...
            <p style="font-size:0.8rem;">Estudios Bíblicos: <strong>${i.estudios || 0}</strong></p>
          </div>
          <div style="text-align:right;">
            <p style="font-size:1.5rem; font-weight:800; color:var(--accent-primary);">${i.horas}</p>
            <p style="font-size:0.7rem; text-transform:uppercase;">Horas</p>
          </div>
        </div>
      `;
    });
